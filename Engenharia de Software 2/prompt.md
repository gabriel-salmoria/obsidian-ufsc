...
faça um resumo em markdown (escreva um bloco de markdown aqui, para que eu possa copiar e modificar em outro espaço) do conteúdo do capitulo dado. o resumo deve ser no formato explicando cada slide usando o material do texto, a ideia é que cada tópico contenha o suficiente para uns 1-2 minutos falando sobre o conteúdo do slide. (o resumo deve contemplar todos os slides, obviamente). aqui segue um trecho de exemplo de como montar cada parte:
